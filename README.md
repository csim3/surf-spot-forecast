...
4. Loaded data from PostgreSQL to Google Sheets. Google Sheets was specifically used since it is a free, web-based program that is accessible for daily, automatic refreshes in Tableau Public.
